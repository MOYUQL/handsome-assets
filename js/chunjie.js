...
var newYear = () => {
    ...
    jQuery(document).ready(function($) {
        $('#newYear').wpSuperSnow({
            flakes: ['https://alpha-q3.sourcegcdn.com/2023/01/05/JGETJTKw.webp', 'https://alpha-q3.sourcegcdn.com/2023/01/05/mG4gB6H7.webp', 'https://alpha-q3.sourcegcdn.com/2023/01/05/oUBJIYQw.webp'],
            totalFlakes: '100',
            zIndex: '999999',
            maxSize: '30',
            maxDuration: '20',
